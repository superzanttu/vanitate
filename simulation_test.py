...
def main():
    ...
    pygame_font_size_16 = pygame.freetype.ftfont.SysFont("menlo", 12)
    pygame_font_size_22 = pygame.freetype.ftfont.SysFont("menlo", 16)
    pygame_font_size_32 = pygame.freetype.ftfont.SysFont("menlo", 22)
